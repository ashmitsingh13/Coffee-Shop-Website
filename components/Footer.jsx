                    ...
                    <li>
                      ...
                      >
                        ...
                        <span className="relative flex w-2 h-2 -mr-2">
                          <span className="absolute inline-flex w-full h-full bg-black rounded-full opacity-75 animate-ping"></span>
                          <span className="relative inline-flex w-2 h-2 bg-black rounded-full"></span>
                        </span>
                      </a>
                    </li>
                  </ul>
          ...
          <div className="pt-6 mt-12 border-t border-gray-800">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-sm text-black">
                ...
                <a
                  className="inline-block text-black underline transition"
                  href="/"
                >
                  Terms & Conditions
                </a>
